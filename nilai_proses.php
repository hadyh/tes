    ...
    <section class="content container-fluid">
         <div class="box container">
            <div class="box-header">
                <h1> Nilai : <?php echo $_GET['nama_proses'];?> </h1>
            </div>
            ...
            if (isset($_POST['insert_nilai'])){
              ...
              $q = $db->insert($database,"id,nis,nama_proses,nilai","null,'$nis','$nama_proses','$nilai'");
              if ($q){
                ...
                <tbody>
                  ...
                  if ($db->getTableRows($q) === 0){
                     echo "tidak ada data";
                      ...
                      echo "<a href='lihat_nilai_proses.php?nis=".$row['nis']."&nama_proses=".$_GET['nama_proses']."&database=".$_GET['database']."' ><button class='tambah_nilai btn btn-warning'> lihat nilai </button> </a>
                             </td>";
                      }
