    ...
    <section class="content container-fluid">
         <div class="box container">
            <div class="box-header">
                <h1> Ulangan Harian : <?php echo $_GET['nama_ulangan_harian'];?> </h1>
            </div>
            ...
            if (isset($_POST['insert_nilai'])){
              ...
              $nama_uh = $_GET['nama_ulangan_harian'];
              $q = $db->insert($database,"id,nis,ulangan_harian,nilai","null,'$nis','$nama_uh','$nilai'");
              if ($q){
                ...
                <tbody>
                  ...
                  if ($db->getTableRows($q) === 0){
                     echo "tidak ada data";
                      ...
                      echo "<a href='lihat_nilai_uh.php?nis=".$row['nis']."&nama_ulangan_harian=".$_GET['nama_ulangan_harian']."&database=".$_GET['database']."' ><button class='tambah_nilai btn btn-warning'> lihat nilai </button> </a>
                             </td>";
                      }
