    ...
    <section class="content container-fluid">
         <div class="box container">
            <div class="box-header">
                <h1> Tugas : <?php echo $_GET['nama_tugas'];?> </h1>
            </div>
            ...
            if (isset($_POST['insert_nilai'])){
              ...
              $q = $db->insert($database,"id,nis,nama_tugas,nilai","null,'$nis','$nama_tugas','$nilai'");
              if ($q){
                ...
                <tbody>
                  ...
                  if ($db->getTableRows($q) === 0){
                     echo "tidak ada data";
                      ...
                      echo "<a href='lihat_nilai_pengetahuan.php?nis=".$row['nis']."&nama_tugas=".$_GET['nama_tugas']."&database=".$_GET['database']."' ><button class='tambah_nilai btn btn-warning'> lihat nilai </button> </a>
                             </td>";
                      }
